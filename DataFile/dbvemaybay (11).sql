...
CREATE TABLE IF NOT EXISTS `ct_dat_ve` (
  ...
  `hang_bay` varchar(45) CHARACTER SET utf8 NOT NULL,
  `dat_ve_id` varchar(100) COLLATE utf8_estonian_ci NOT NULL,
  `crypt` varchar(255) CHARACTER SET utf8 NOT NULL,
  `chuyen_bay` varchar(50) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`ct_dat_ve_id`),
  KEY `dat_ve_id` (`dat_ve_id`),
  KEY `hanh_ly_id` (`hanh_ly_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_estonian_ci AUTO_INCREMENT=115 ;

--
-- Dumping data for table `ct_dat_ve`
--

INSERT INTO `ct_dat_ve` (`ct_dat_ve_id`, `ten_kh`, `ngay_sinh`, `hang_ve`, `hanh_ly_id`, `gio_bay`, `hang_bay`, `dat_ve_id`, `crypt`, `chuyen_bay`) VALUES
...
(97, 'Nguyễn Việt', '1920-01-01', 'Economy Save  ', 1, '19:20  - 21:20 ', 'VNairlines', '18520538db763828a7', 'VNA#C0gDVsWS1ybIZIHvoEI9PY6xgjUrqAjc5N+rmTmE/CUZjbOG8Q6HOEl3BxNVVRbKX/ZRIPY13lJiSsnjq0rSKjzNIoLE1SUfYn75L5bIQIQKZEkbtr2DMPMI98ejFf7p', ''),
(98, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '17:30  - 19:30 ', 'VNairlines', '18520538db763828a7', 'VNA#86yaFqcN+dtir1/CJbpPSk/eAhFzNCTP1VTP5f2qL+HmCnIv+1VaGKiEikktz7cEs08ya2H4p0BoHj30D807noAZ0TYXYi0k6yh1YB14DR4uTZgDsy7ScPPg/LXA+Ybn', ''),
(99, 'Nguyễn Việt', '1920-01-01', 'Economy Save  ', 1, '19:20  - 21:20 ', 'VNairlines', '22523538db82b4fd05', 'VNA#0D0/1h9AFmGq68GsfPZ4S3q4yi/3aIVWjtB56sF6xvFDj2clN1sPZ8IzpX/+u1vgTV4zw4b7wmzYQAjeleOVet+1hFvEubf50V3eG87vhYMZUT0IZKPR3Qg3wB5d8dOX', ''),
(100, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '18:30  - 20:30 ', 'VNairlines', '22523538db82b4fd05', 'VNA#zYHBlZJnaQkO0EDzrY9aV966Ehg5Lr271CKuvIBxtGmYsPxNq2Rev9OIi3uTdg3AMGVV40gi8zYOQMx85/q8aD0h6Hr57VSYo3GPWc1YNjzEhqcWx7qq4PbEmfY5+Tgp', ''),
(101, 'Nguyễn Việt', '1920-01-01', 'Economy Save  ', 1, '21:20  - 23:20 ', 'VNairlines', '25072538dc0389949a', 'VNA#F5hLdeVf6DLkV0Zjgemlpmw6YluM3Q4L1CUku0AuhtKyjU7LM2gl8VtQxCf8Vh9h+Q+Cj9DJrU8FvUaw9mNYPle1p4/sNMlYQm9TAs1Z3UgwpYJWsXdrZN31CeT8uc2E', ''),
(102, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '19:00  - 21:00 ', 'VNairlines', '25072538dc0389949a', 'VNA#UzgDjPPW9Ac1xx/1I5aeApNYK478DEejsiYH7DSZM1g0Y+qO7/mmsbE78gsb4u2fanqtjH+poMkrFyj2UxP6b/deLR8jJBhONc3saF7NzyOV0Mw8FViX74+O8w6WgVWg', ''),
(103, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '18:00  - 20:00 ', 'VNairlines', '2228353944117c4ad4', 'VNA#D0Oza+umWE+80JSK0R4iB0MVwUggBlHL0kkyXysmZmyzv0kyevOT+EvJoh04cAMID3UeuUzGRADmBnPyLUvFkB+R9qE4UncvzW7PRy90yip5H20QLvc+P1Q+uxvRyqFd', ''),
(104, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '20:05  - 22:05 ', 'VNairlines', '2228353944117c4ad4', 'VNA#i6cdGQeiq8dPQFjkUefuXCjU4Son1ct/ijjC/widfVPIR2DP+gUu6KWU4xR+XQk/jJkSqYmI8jgQaAr6RE+HMq0Zl6h1N+odlVGrKDAseyMw3IS3XNspmpfAwNbIoO3p', ''),
(105, 'Lê Lợi', '1920-01-01', 'Economy Standard  ', 1, '15:50  - 17:50 ', 'VNairlines', '1718653a2f02e1fc99', 'VNA#txlUn0doRiC9cDV61shkI3erRVUmPgM+kb6/MKWylyE+8oZ6N1SIzg/MOcOlCWJJti0xM8maTnzmYh8vKFMLG0T3TWQBU3Bt38BSm4szZ4VnItUbFKajMRhbpmOPJwlI', ''),
(106, 'Lê Lợi', '1920-01-01', 'Economy Save  ', 1, '21:55  - 23:55 ', 'VNairlines', '1718653a2f02e1fc99', 'VNA#7QsH962Aa1qAvfCgegYeJLopS8lcWxljDr1qf/x702/quNg8VRO9KqK+8pvQcRLmzBK5GZ1BYv1Z4oo8qNsMV+rCwQb4fwY42sedMA4vtEfB2u3vmGYgRfVeJGXpX2xp', ''),
(107, 'Nguyễn Việt', '1920-01-01', 'Economy Standard  ', 1, '15:50  - 17:50 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#TIIEXOCfQYbyw0nTsoV8LvFYdu6CThhSTE8xCRPibA6pN5maHHpNonbQIYGWs8Z+1Cr48oEEPWmc3Wu9D5v7gR4cZIDI3CNRqwIOQWb+QuRfqCaTX9VLTQBBX6JsM2fA', 'VN 7246'),
(108, 'Trần Đức', '1920-01-01', 'Economy Standard  ', 1, '15:50  - 17:50 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#TIIEXOCfQYbyw0nTsoV8LvFYdu6CThhSTE8xCRPibA6pN5maHHpNonbQIYGWs8Z+1Cr48oEEPWmc3Wu9D5v7gR4cZIDI3CNRqwIOQWb+QuRfqCaTX9VLTQBBX6JsM2fA', 'VN 7246'),
(109, 'Tí Béo', '2010-01-01', 'Economy Standard  ', 1, '15:50  - 17:50 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#TIIEXOCfQYbyw0nTsoV8LvFYdu6CThhSTE8xCRPibA6pN5maHHpNonbQIYGWs8Z+1Cr48oEEPWmc3Wu9D5v7gR4cZIDI3CNRqwIOQWb+QuRfqCaTX9VLTQBBX6JsM2fA', 'VN 7246'),
(110, 'Zun', '2014-01-01', 'Economy Standard  ', 1, '15:50  - 17:50 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#TIIEXOCfQYbyw0nTsoV8LvFYdu6CThhSTE8xCRPibA6pN5maHHpNonbQIYGWs8Z+1Cr48oEEPWmc3Wu9D5v7gR4cZIDI3CNRqwIOQWb+QuRfqCaTX9VLTQBBX6JsM2fA', 'VN 7246'),
(111, 'Nguyễn Việt', '1920-01-01', 'Economy Save  ', 1, '21:55  - 23:55 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#WQk0D/zMtB81z/c8DKrfsMgaSooJJIsYclP1kTe6qYFue6s4Dm6xynigkl4AcnsvcnLigrt81MM1yFwoPGQi7ra04p9IxBCU7fguHhYtdv9KZ7o0hlAkw72kD+H1CXQK', 'VN 279'),
(112, 'Trần Đức', '1920-01-01', 'Economy Save  ', 1, '21:55  - 23:55 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#WQk0D/zMtB81z/c8DKrfsMgaSooJJIsYclP1kTe6qYFue6s4Dm6xynigkl4AcnsvcnLigrt81MM1yFwoPGQi7ra04p9IxBCU7fguHhYtdv9KZ7o0hlAkw72kD+H1CXQK', 'VN 279'),
(113, 'Tí Béo', '2010-01-01', 'Economy Save  ', 1, '21:55  - 23:55 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#WQk0D/zMtB81z/c8DKrfsMgaSooJJIsYclP1kTe6qYFue6s4Dm6xynigkl4AcnsvcnLigrt81MM1yFwoPGQi7ra04p9IxBCU7fguHhYtdv9KZ7o0hlAkw72kD+H1CXQK', 'VN 279'),
(114, 'Zun', '2014-01-01', 'Economy Save  ', 1, '21:55  - 23:55 ', 'VNairlines', '1567553a2f0fc6e84c', 'VNA#WQk0D/zMtB81z/c8DKrfsMgaSooJJIsYclP1kTe6qYFue6s4Dm6xynigkl4AcnsvcnLigrt81MM1yFwoPGQi7ra04p9IxBCU7fguHhYtdv9KZ7o0hlAkw72kD+H1CXQK', 'VN 279');
...
('1567553a2f0fc6e84c', 11272086, 'SGN', 'HAN', '2014-06-20', '2014-06-20', 'Nguyễn Văn Quyền', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 1),
...
('1718653a2f02e1fc99', 3779998, 'SGN', 'HAN', '2014-06-20', '2014-06-20', 'Nguyễn Trung Việt', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 1),
('18520538db763828a7', 4229998, 'SGN', 'HAN', '2014-06-04', '2014-06-04', 'Nguyễn Trung Việt', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 1),
...
('2228353944117c4ad4', 4479998, 'SGN', 'HAN', '2014-06-09', '2014-06-09', 'Nguyễn Trung Việt', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 2),
('22523538db82b4fd05', 4229998, 'SGN', 'HAN', '2014-06-04', '2014-06-04', 'Nguyễn Trung Việt', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 1),
('25072538dc0389949a', 4229998, 'SGN', 'HAN', '2014-06-04', '2014-06-04', 'Nguyễn Trung Việt', 903676222, 'vietnt134@gmail.com', '47/8/5, Đ.2, P.Bình An, Q.2', 'Việt Nam', 'TP Hồ Chí Minh', 1),
...
('HUI', 'Huế', 'Huế'),
('NHA', 'Nha Trang', 'Nha Trang'),
('PQC', 'Phú Quốc', 'Phú Quốc'),
('PXU', 'Pleiku', 'Pleiku'),
('SGN', 'Tân Sơn Nhất', 'Sài Gòn'),
('TBB', 'Tuy Hòa', 'Tuy Hòa'),
('THD', 'Thanh Hóa', 'Thanh Hóa'),
('UIH', 'Quy Nhơn', 'Quy Nhơn'),
('VCA', 'Cần Thơ', 'Cần Thơ'),
('VCL', 'Chu Lai', 'Chu Lai'),
('VCS', 'Côn Đảo', 'Côn Đảo'),
