<div class="row">
	<div class="col-sm-12 well">
		<div class="row">
			<div class="col-sm-4">
				<h2 class=""><strong>Vé Máy Bay JetStar</strong></h2>
				<p class="text-orange">
					<strong> Jetstar Pacific là hãng hàng không giá rẻ đầu tiên tại Việt Nam,
					chính thức tham gia hoạt động cùng hệ thống Jetstar toàn cầu từ tháng 5 năm 2008.
					Bằng nỗ lực cung cấp cho hành khách mức giá rẻ mỗi ngày, Jetstar mang sứ mệnh giúp
					mọi người ngày càng được bay thường xuyên hơn, đồng thời mở ra cơ hội du lịch bằng
			...
			<div class="col-sm-4">
				...
				<p class="text-danger">
					<strong> VietJet Air được thành lập từ 03 cổ đông chính là Tập đoàn T&C, Sovico Holdings và
					Ngân hàng Thương mại Cổ phần Phát triển Nhà TP Hồ Chí Minh (HD Bank), với vốn điều lệ ban đầu
